...
foreach( $codes as $slug => $shortcode ) {
	...
	if ( count( $shortcode['atts'] ) && $shortcode['atts'] ) {
		foreach ( $shortcode['atts'] as $attr_name => $attr_info ) {
			...
			$return .= '<p>';
			$return .= '<a rel="tooltip" class="aesop-option-tip" href="#" data-toggle="tooltip" data-placement="top" title="'.$attr_info['tip'].'" ><i class="dashicons dashicons-editor-help"></i></a>';
