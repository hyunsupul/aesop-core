...
class AesopMapComponentAdmin {
	...
	public function new_map_assets( $hook ) {
		...
		if ( $hook == 'post.php' || $hook == 'post-new.php' ) {
			...
			wp_enqueue_script( 'aesop-map-script', AI_CORE_URL.'/public/includes/libs/leaflet/leaflet.js',array(), AI_CORE_VERSION);
			wp_enqueue_script( 'jquery-geocomplete', AI_CORE_URL.'/admin/assets/js/vendor/jquery.geocomplete.min.js',array(), AI_CORE_VERSION);
			wp_enqueue_style( 'aesop-map-style', AI_CORE_URL.'/public/includes/libs/leaflet/leaflet.css', array(),AI_CORE_VERSION );
		}
