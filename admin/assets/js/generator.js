jQuery(document).ready(function ($) {
    ...
    jQuery(document).on('click', '#aesop-generator-insert,.aesop-generator', function (e) {
        ...
        var scAtts = '';
        $("#aesop-generator-settings").find(':input').each(function () {
            ...
            if ($(this).val() !== '') {
                ...
                scAtts = scAtts + ' ' + $(this).attr('name') + '="' + val + '"';
            }
        });
        // console.log(scAtts);
        ...
        /* TODO - remove
                ...
                */
        $('#aesop-generator-result').val($('#aesop-generator-result').val() + ' ' + scAtts + ']');

       // console.log($('#aesop-generator-result').val());
