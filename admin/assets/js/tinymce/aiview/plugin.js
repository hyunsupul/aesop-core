...
tinymce.PluginManager.add('aiview', function( editor ) {
	...
	function html( cls, data ) {
		...
		var st = '<div data-mce-resize="false" data-mce-placeholder="1" class="mceItem ' + cls + '"><div class="aesop-component-bar mceNonEditable"><span class="mceNonEditable aesop-' + parse[1] + '-title">' + parse[1] + '</span></div><div class="aesop-component-content aesop-' + parse[1] + '" data-aesop-sc="' + data + '">' + parse[3] + '</div></div>';
		return st;
	}
