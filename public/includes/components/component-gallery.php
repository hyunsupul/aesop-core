	...
	*/
	function aesop_post_gallery($atts, $content = null){
		...
		ob_start();
			...
			?><div contenteditable="false" id="aesop-gallery-<?php echo esc_attr( $unique );?>" class="aesop-component aesop-gallery-component aesop-<?php echo esc_attr($type);?>-gallery-wrap"><?php
