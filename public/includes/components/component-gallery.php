	...
	*/
	function aesop_post_gallery($atts, $content = null){
		...
		ob_start();
			...
			?><div id="aesop-gallery-<?php echo esc_attr( $unique );?>" <?php echo esc_attr( aesop_component_data_atts( 'gallery', $gallery_id, $defaults ) );?> class="aesop-component aesop-gallery-component aesop-<?php echo esc_attr($type);?>-gallery-wrap"><?php
