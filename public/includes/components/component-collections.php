...
if (!function_exists('aesop_collection_shortcode')){
	...
	function aesop_collection_shortcode($atts, $content = null) {
		...
		?>
			<!-- Collections -->
			<div <?php echo esc_attr( aesop_component_data_atts( 'collection', $unique, $defaults ) );?> class="aesop-story-collection aesop-component <?php echo sanitize_html_class($classes);?>">
