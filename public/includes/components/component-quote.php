...
if (!function_exists('aesop_quote_shortcode')){
	...
	function aesop_quote_shortcode($atts, $content = null) {
		...
		// actions
		$actiontop = do_action('aesop_quote_before');
		$actionbottom = do_action('aesop_quote_after');
		$actioninsidetop = do_action('aesop_quote_inside_top');
		$actioninsidebottom = do_action('aesop_quote_inside_bottom');
