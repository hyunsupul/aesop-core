...
if (!function_exists('aesop_content_shortcode')){
	...
	function aesop_content_shortcode($atts, $content = null) {
		...
		do_action('aesop_cbox_before'); //action
			?>
				<div <?php echo esc_attr( aesop_component_data_atts( 'content', $unique, $atts, true ) );?> class="aesop-component aesop-content-component <?php echo sanitize_html_class($classes).' '.$has_img. ' '.$has_floater;?>" style="<?php echo $height;?>" >
