...
if (!function_exists('aesop_image_shortcode')){
	...
	function aesop_image_shortcode($atts, $content = null) {
		...
		?>
		<div contenteditable="false" data-unique="<?php echo esc_attr( $unique );?>" id="aesop-image-component-<?php echo esc_html( $unique );?>" data-component-type="image" class="aesop-component aesop-image-component <?php echo sanitize_html_class( $classes );?>" >
