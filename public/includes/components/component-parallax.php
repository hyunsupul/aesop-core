...
if (!function_exists('aesop_parallax_shortcode')){
	...
	function aesop_parallax_shortcode($atts, $content = null) {
		...
		do_action('aesop_parallax_before'); //action
			...
			?><div data-unique="<?php echo esc_attr( $unique );?>" id="aesop-parallax-component-<?php esc_attr( $unique );?>" class="aesop-component aesop-parallax-component <?php echo sanitize_html_class( $classes );?>"><?php
