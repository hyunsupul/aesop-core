...
if ( ! function_exists( 'aesop_map_shortcode' ) ) {
    function aesop_map_shortcode( $atts ) {
        ...
        // enable map component for all post types
        $default_location = true;//is_single();
        ...
        <div id="aesop-map-component" <?php echo aesop_component_data_atts( 'map', $unique, $atts ); ?>
             class="aesop-component aesop-map-component <?php echo sanitize_html_class( $classes ); ?> " <?php echo $height; ?>>
        ...
        do_action( 'aesop_map_after', $atts, $unique );
...
class AesopMapComponent {
     ...
     *
     * @param unknown $markers - array - gps coordinates entered aspost meta
     *                         within respective post
     *
     ...
     * Note: this is ONLY used when maps is in sticky mode, considered an
     * internal but public function
     *
     *
     */
