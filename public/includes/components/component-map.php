	...
	function aesop_map_shortcode($atts, $content = null) {
		...
		*/
		...
		do_action('aesop_map_before');
			?><div <?php echo aesop_component_options_as_atts($atts);?> data-unique="<?php echo esc_attr( $unique );?>" id="aesop-map-component" class="aesop-component aesop-map-component <?php echo sanitize_html_class($classes);?> " <?php echo $height;?>></div><?php
		do_action('aesop_map_before');
