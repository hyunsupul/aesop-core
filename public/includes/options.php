...
class AesopStoryEngineOptions {
	...
	public static function register($wp_customize){
		...
		$wp_customize->add_section( 'aesop_story_engine', array(
			...
			'description'	=> __('Refer to the documentation located <a href="http://aesopstoryengine.com/documentation" target="_blank">here</a> for full option descriptions.', 'aesop-core')
		) );
